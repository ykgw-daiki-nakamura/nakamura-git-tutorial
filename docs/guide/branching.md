...
ここで見た**ローカルの merge の形（Fast-forward / 3-way）**を踏まえると、GitHub 上で PR をマージするときの **Merge / Squash / Rebase and merge** の選び方が理解しやすくなります。その使い分けは [プルリクエストとレビュー](./pull-request) を参照してください。
